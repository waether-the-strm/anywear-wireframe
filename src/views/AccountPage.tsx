      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="bg-white rounded shadow p-6 min-h-[500px] flex-grow">
          {tab === 'dashboard' && (
            <div>
              ...
              <div className="mb-6">
                <p className="text-gray-700 mb-4">Witaj, Jan! Ostatnia aktualizacja danych: 2025-08-20</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded">
                    ...
                    <p className="text-sm text-gray-700 mb-1">jan.kowalski@email.com</p>
                    <p className="text-sm text-gray-700">+48 123 456 789</p>
                    <button className="text-blue-600 text-sm mt-2" onClick={() => setTab('personal')}>Edytuj dane</button>
                  </div>
                </div>
              </div>
              
              <h3 className="font-semibold mb-4 border-b pb-2">Bieżące zamówienia</h3>
              <div className="space-y-4 mb-6">
                <div className="border p-4 rounded">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      <div className="font-bold">#ANW-2025-0001</div>
                      <div className="text-sm text-gray-600">27 sierpnia 2025 (wczoraj)</div>
                    </div>
                ...
                <div className="border p-4 rounded">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      ...
                      <div className="text-sm text-gray-600">20 sierpnia 2025 (8 dni temu)</div>
                    </div>
                    <div className="text-right">
              ...
              <div className="flex justify-between">
                <button className="bg-black text-white px-4 py-2 rounded" onClick={() => setTab('orders')}>
        ...
        {tab === 'personal' && (
          <form className="space-y-4">
            ...
            <div>
              ...
              <input className="border rounded px-3 py-2 w-full" type="text" defaultValue="Jan" />
            </div>
            <div>
              <label className="block text-sm mb-1">Nazwisko</label>
              <input className="border rounded px-3 py-2 w-full" type="text" defaultValue="Kowalski" />
            </div>
            <div>
              <label className="block text-sm mb-1">Email</label>
              <input className="border rounded px-3 py-2 w-full" type="email" defaultValue="jan.kowalski@email.com" />
            </div>
            <div>
              <label className="block text-sm mb-1">Telefon</label>
              <input className="border rounded px-3 py-2 w-full" type="tel" defaultValue="+48 123 456 789" />
            </div>
            <div>
              <label className="block text-sm mb-1">Zmień hasło</label>
              <input className="border rounded px-3 py-2 w-full" type="password" placeholder="Nowe hasło" />
            </div>
            <button className="bg-black text-white px-4 py-2 rounded" type="submit">Zapisz zmiany</button>
          </form>
        )}
        ...
        {tab === 'addresses' && (
          <div>
            ...
            <div className="mb-4">
              ...
              <div className="text-sm text-gray-700">ul. Przykładowa 1, 00-000 Warszawa</div>
            ...
            <button className="mt-4 bg-black text-white px-4 py-2 rounded">Dodaj nowy adres</button>
          </div>
        )}
        ...
        {tab === 'orders' && (
          <div>
            ...
            <table className="w-full text-sm mb-4">
              ...
              <tbody>
                <tr className="border-b hover:bg-gray-50">
                  ...
                  <td>318,00 zł</td>
                  <td>
                    <button className="text-blue-600 text-xs">Szczegóły</button>
                  </td>
                </tr>
                <tr className="border-b hover:bg-gray-50">
            ...
            <div className="flex justify-between">
              <button className="bg-gray-100 text-black px-4 py-2 rounded">Pobierz faktury</button>
              <div className="text-sm text-gray-500">Łącznie: 4 zamówienia</div>
            </div>
          </div>
        )}
        ...
        {tab === 'returns' && (
          <div>
              ...
              <div className="border p-4 rounded">
                <div className="flex justify-between">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Do zamówienia: #ANW-2025-0003</div>
                  </div>
              ...
              <div className="border p-4 rounded">
                <div className="flex justify-between">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Do zamówienia: #ANW-2025-0004</div>
                  </div>
            ...
            <button className="bg-black text-white px-4 py-2 rounded">Zgłoś nowy zwrot/reklamację</button>
          </div>
        )}
                ...
                <div className="flex justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">Wygasa: 09/27</div>
                    </div>
                  </div>
                  <div className="flex gap-2 items-start">
                    <button className="text-sm border px-3 py-1 hover:bg-gray-100">Ustaw jako domyślną</button>
                    <button className="text-sm border border-red-200 text-red-600 px-3 py-1 hover:bg-red-50">Usuń</button>
                  </div>
                </div>
              </div>
              <div className="border p-4 rounded">
                <div className="flex justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="font-medium">BLIK - Płatność mobilna</div>
                      <div className="text-sm text-gray-600">Powiązany z +48 123 *** 789</div>
                    </div>
                  </div>
                  <div className="flex gap-2 items-start">
                    <div className="text-sm bg-gray-100 text-gray-800 px-2 py-1 rounded">Domyślna</div>
                    <button className="text-sm border border-red-200 text-red-600 px-3 py-1 hover:bg-red-50">Usuń</button>
                  </div>
                </div>
              </div>
            </div>
            <button className="bg-black text-white px-4 py-2 rounded">Dodaj nową metodę płatności</button>
          </div>
        )}
            ...
            <div className="mb-6">
              ...
              <div className="space-y-2 mb-4 bg-gray-50 p-4 rounded">
                <label className="flex items-center">
                  ...
                  <span className="text-sm">Zgadzam się na otrzymywanie newslettera</span>
                </label>
                <label className="flex items-center">
                  <input type="checkbox" className="mr-2" />
                  <span className="text-sm">Zgadzam się na przetwarzanie danych w celach marketingowych</span>
                </label>
                <label className="flex items-center">
                  <input type="checkbox" className="mr-2" defaultChecked />
                  <span className="text-sm">Zgadzam się na otrzymywanie powiadomień o promocjach</span>
                </label>
              </div>
              <button className="bg-black text-white px-4 py-2 rounded">Zapisz zgody</button>
            </div>
            <div className="mb-6">
              ...
              <div className="flex gap-2">
                <button className="bg-gray-100 text-black px-4 py-2 rounded">Pobierz moje dane</button>
                <button className="bg-red-600 text-white px-4 py-2 rounded">Usuń konto</button>
              </div>
            </div>
            <div>
              <div className="font-medium mb-1">Dokumenty</div>
              <div className="space-y-2 text-sm">
                <div><a href="/privacy-policy" className="text-blue-600 hover:underline">Polityka prywatności</a></div>
                <div><a href="/terms" className="text-blue-600 hover:underline">Regulamin sklepu</a></div>
                <div><a href="/cookies" className="text-blue-600 hover:underline">Polityka cookies</a></div>
              </div>
            </div>
          </div>
        )}
