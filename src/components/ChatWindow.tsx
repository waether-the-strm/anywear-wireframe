            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <div className={`w-2 h-2 rounded-full ${
                  agentStatus === 'available' ? 'bg-green-500 pulse-animation' : 
                  agentStatus === 'busy' ? 'bg-yellow-500' : 'bg-red-500'
                }`}></div>
                <span className="text-sm font-medium text-gray-800">
                  Konsultant {agentStatus === 'available' ? 'online' : agentStatus === 'busy' ? 'zajęty' : 'offline'}
                </span>
              </div>
              <button 
      ...
      <div className="border-t border-gray-200 bg-white rounded-b-lg">
        ...
        <form onSubmit={handleSendMessage} className="p-3">
          ...
          <div className="flex justify-between items-center mt-2">
            ...
            <a href="/privacy-policy" className="text-xs text-gray-500 hover:text-black underline">
